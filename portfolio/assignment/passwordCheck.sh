...
# Last Edited: 13 August 2024 Minor formating changes
# -----------------------------------------------------
...
case $num_pwd in
    0)
        ...
        echo -e "\033[031mError: \033[032mNo password file exist!\033[0m\n" 
        exit 2
        ;;
    1)
        ...
        if [ "$p_newhash" = "$p_oldhash" ]; then
            ...
            echo -e "\n\033[031mAccess Denied!\033[032m\n"
            exit 1
        fi
        ;;
    *)
        echo -e "\n\033[031mError:\033[032m More than one password file!\n"
        exit 3
esac
